...
###
#original
#matriz_toga = pd.read_table(nombre_archivo, delim_whitespace = True, names = ["StationID", "StationName", "Date", "D1", "D2", "D3", "D4", "D5", "D6", "D7", "D8", "D9", "D10", "D11", "D12"], engine = 'python', skiprows = 1, na_values = "9999")
#se le agrega esto en este fragmento sep=r"\s+"
matriz_toga = pd.read_table(nombre_archivo, sep=r"\s+", names = ["StationID", "StationName", "Date", "D1", "D2", "D3", "D4", "D5", "D6", "D7", "D8", "D9", "D10", "D11", "D12"], engine = 'python', skiprows = 1)
print("matriz_toga", matriz_toga)
###
...
if len(sys.argv) > 2:
    ...
    for ind in range(len(lista_datos)):
        ...
        if lista_datos[ind] < rinf or lista_datos[inf] > rsup:
