...
plt.plot(lista_stuck_fechas, lista_stuck_datos, "-k", label="Stuckdata", marker="*",linestyle = 'None')
...
plt.savefig("plot_"+os.path.splitext(nombre_archivo)[0]+".png")
for i in range(1,13):
    ...
    plt.savefig(str(i)+"_plot_"+os.path.splitext(nombre_archivo)[0]+".png")
