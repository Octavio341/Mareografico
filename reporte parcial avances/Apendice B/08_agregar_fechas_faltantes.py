...
archivo_salida = open("completed-"+nombre_archivo, 'w+')
...
matriz_toga = pd.read_table(nombre_archivo, delim_whitespace = True, names = ["StationID", "StationName", "Date", "D1", "D2", "D3", "D4", "D5", "D6", "D7", "D8", "D9", "D10", "D11", "D12"], engine = 'python', skiprows = 1)
ind = 0
